                        ...
                        <div class="account-pages">
                            <div class="account-box">
                                <div class="account-logo-box">
                                    ...
                                    <h6 class="text-uppercase text-center font-bold mt-4">Registration</h6>
                                </div>
                                <div class="account-content">
                                    <form class="form-horizontal" method="POST" action="{{ url('/loginProcess') }}"
                                        ...
                                        <div class="form-group row m-b-20">
                                            <div class="col-12">
                                                ...
                                                <input class="form-control @error('password') is-invalid @enderror"
                                                    ...
                                                    required
                                                    data-parsley-required-message='<p style="color:red;">Password is required</p>'>
                                                @error('password')
